...
const faceGroup = new THREE.Group(); //구릅을 지어서 한 통으로 움직일 수 있도록 한다.
...
const init = () => {
  ...
  renderer = new THREE.WebGLRenderer({ antialias: true }); //안티에얼리스는 모서리를 부드럽게 해준다.
  ...
  //기본 도형으로 얼굴 만들기
  const geometry = new THREE.BoxBufferGeometry(30, 25, 12);
